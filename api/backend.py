...
async def chat(request: ChatRequest):
    ...
    async with httpx.AsyncClient(timeout=120.0) as client:
        ...
        system_prompt = (
            ...
            "COLUMN HEADERS must be SHORT — maximum 3 words each. Never write a long phrase as a column header. "
            "Good examples: 'Scenario', 'Approach', 'Reason', 'Model', 'Cost', 'Accuracy'. "
            "Bad example: 'Recommended Approach for NOx Control via Residence Time' — this is too long. "
