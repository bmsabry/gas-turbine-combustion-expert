...
async def chat(request: ChatRequest):
    ...
    async with httpx.AsyncClient(timeout=120.0) as client:
        ...
        system_prompt = (
            ...
            "1. THINK COMPREHENSIVELY FIRST: Before writing, identify ALL relevant dimensions, "
            "mechanisms, sub-topics, and engineering considerations the question touches. "
            "Cover every dimension — do not just summarize the top retrieved chunks.\n"
            "2. STRUCTURE YOUR ANSWER: Use clear markdown headers (###) to organize complex answers. "
            "Use bullet points for lists of factors/mechanisms. Use comparison tables when evaluating "
